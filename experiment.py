...
class Experiment(object):
    ...
    def _run(self, dataset, config: dict):
        ...
        score, k, indices = self._features_selection(Loader(SpreadSheetNLPCustomDataset(dataset, self.classifier.tokenizer), self.classifier.bs, shuffle=True, num_workers=4))
