...
class NLPClassifier(object):
    def __init__(self, config : dict):
        ...
        if config["train"]:
            ...
            self.scheduler = transformers.get_cosine_with_hard_restarts_schedule_with_warmup(self.optimizer, 500, self.final_epoch-self.curr_epoch)#torch.optim.lr_scheduler.StepLR(self.optimizer, 2.4, 0.97)
